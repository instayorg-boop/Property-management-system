        ...
        <div className="mx-auto w-full max-w-[320px]">
          ...
          {checkEmail ? (
            <>
              ...
              <Link
                to="/sign-in"
                className="mt-5 block w-full rounded-lg bg-brand py-2 text-center text-[13px] font-medium text-paper transition-transform hover:scale-[1.01]"
              >
                Back to sign in
              </Link>
            </>
            ...
            <>
              ...
              <p className="mt-1.5 text-[13px] text-muted">Free to start. No credit card required.</p>
